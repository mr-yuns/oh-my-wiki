...
Usage:
  ...
  omw capture --title "<title>" [--type agent_session|discussion] [--stdin|--body <text>] [--dry-run] [--json]
  omw queue [--json]
  ...
  omw daily --author "<name>" --team "<team>" --date YYYY-MM-DD [--stdin|--body <text>] [--dry-run] [--json]
...
Usage:
  ...
  omw wiki capture --title "<title>" [--type agent_session|discussion] [--stdin|--body <text>] [--dry-run] [--json]
  omw wiki queue [--json]
  ...
  omw wiki daily --author <name> --team <team> --date YYYY-MM-DD [--stdin|--body <text>] [--dry-run] [--json]
