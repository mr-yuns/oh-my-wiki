...
3. If `understanding.score` is below `100`, follow the `wiki-deep-interview` handoff prompt and answer missing dimensions before ingest previews, drafts, or promotions that depend on Raw structure.
